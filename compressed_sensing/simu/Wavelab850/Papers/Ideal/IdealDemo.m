...
% -------------------------------------------------------
LastFigureNo = 10;
PaperName = 'Ideal Spatial Adaptation via Wavelet Shrinkage';
MakeFigureFilePrefix = 'idfig';
% NRfigures = {1};
% CRfigures = {8,10,11};
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','IdealDemo(''CloseAllDemo'')');
