...
void SetBaseLevelParam( void )
{
  ...
  {
    ATB_SetPulprog("N15cestRARE.4ch");
  }
...
void SetPpgParameters( void )
{
  ...
  ATB_SetPulprog("N15cestRARE.ppg");
  if(PVM_SelIrOnOff)
  {
  ...
  TPQQ[5].power=CESTPulse.Attenuation;
  TPQQ[0].offset = 0.0;
  TPQQ[1].offset = 0.0;
    /**JXU**/
  TPQQ[5].offset = 0.0;
