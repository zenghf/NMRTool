...
void SetPpgParameters( void )
{
  ...
  sprintf(TPQQ[5].name,N15Pulse.Filename);
  if(PVM_DeriveGains == Yes)
  {
    ...
    TPQQ[5].power  = N15Pulse.Attenuation;
  }
  TPQQ[0].offset = 0.0;
  TPQQ[1].offset = 0.0;
  TPQQ[3].offset = 0.0;
