...
void SetPpgParameters( void )
{
  ...
  D[12] = dJCouple / 1000.0;
  D[14] = dExchange / 1000.0;
  D[16] = N15Pulse.Length / 1000.0;
  /**************************************/
  ...
  sprintf(TPQQ[3].name,H90Pulse.Filename);
  sprintf(TPQQ[4].name,H180Pulse.Filename);
  sprintf(TPQQ[6].name,N15Pulse.Filename);
  if(PVM_DeriveGains == Yes)
  {
    TPQQ[0].power  = ExcPulse.Attenuation;
    TPQQ[1].power  = RefPulse.Attenuation;
    TPQQ[3].power  = H90Pulse.Attenuation;
    TPQQ[4].power  = H180Pulse.Attenuation;
    TPQQ[6].power  = N15Pulse.Attenuation;
  }
  TPQQ[0].offset = 0.0;
  TPQQ[1].offset = 0.0;
  TPQQ[3].offset = 0.0;
  ...
  P[3] = H90Pulse.Length * 1000;
  P[4] = H180Pulse.Length * 1000;
  P[6] = N15Pulse.Length * 1000;
